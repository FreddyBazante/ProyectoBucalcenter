...
public class LoginPaciente {
	...
	public int validar_usuario(LoginPaciente l){
		cx.con();
	...
	public LoginPaciente getUsuario(LoginPaciente lp){		
		LoginPaciente user = new LoginPaciente();
		String com = "SELECT * FROM PACIENTE " +
				"WHERE NOMRE_USR='"+lp.getNombre_usuario_usuario()+"' " +
						"AND PASSWORD_USR='"+lp.getPassword_usuario()+"' " +
								"AND ESTADO_USR='1'";
		try {
			cx.con();
