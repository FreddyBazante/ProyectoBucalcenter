...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="a" class="com.ec.bucalcenter.modelo.Administrador" scope="page" />
...
String ocupacion = "";
String estado = "";
a.setId_administrador(id);
ResultSet rsp = a.buscar_administrador(a);
while (rsp.next()){
	 id = rsp.getInt(1);
...
<form action="cAdministrador" method="post" id="formulario_administrador" onSubmit="return validarPasswd()">
	<fieldset>
	...
	<hr>
	<jsp:include page="ListarAdministrador.jsp" flush="true"/>
	</div>	
	</article>
